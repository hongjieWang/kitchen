...
public class PropertyConfigurator implements Configurator {
    ...
    protected void parseCatsAndRenderers(Properties props, LoggerRepository hierarchy) {
        ...
        while (enumeration.hasMoreElements()) {
            ...
            if ("log4j.throwableRenderer".equals(key) &&
    ...
    Appender parseAppender(Properties props, String appenderName) {
        ...
        if (appender instanceof com.kitchen.god.sdk.log4j.spi.OptionHandler) {
    ...
    void parseAppenderFilters(Properties props, String appenderName, Appender appender) {
        ...
        Hashtable<Object, Object> filters = new Hashtable<Object, Object>();
        ...
        while (e.hasMoreElements()) {
            ...
            if (key.startsWith(filterPrefix)) {
                ...
                Vector<NameValue> filterOpts = (Vector) filters.get(filterKey);
                if (filterOpts == null) {
        ...
        Enumeration<String> g = new SortedKeyEnumeration(filters);
