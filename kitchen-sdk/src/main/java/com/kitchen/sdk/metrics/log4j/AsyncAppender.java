...
import com.kitchen.sdk.metrics.log4j.helpers.AppenderAttachableImpl;
import com.kitchen.sdk.metrics.log4j.helpers.LogLog;
import com.kitchen.sdk.metrics.log4j.spi.AppenderAttachable;
...
public class AsyncAppender extends AppenderSkeleton implements AppenderAttachable {
    ...
    private final Map discardMap = new HashMap<Object, Object>();
    ...
    private static final class DiscardSummary {
        ...
        public LoggingEvent createEvent() {
            ...
            return new LoggingEvent("cn.org.bjca.footstone.metrics.client.log4j.AsyncAppender.DONT_REPORT_LOCATION", Logger.getLogger(this.maxEvent.getLoggerName()), this.maxEvent.getLevel(), msg, null);
        }
    }
                ...
                while (isActive) {
                    ...
                    synchronized (this.buffer) {
                        ...
                        if (bufferSize > 0) {
                            ...
                            Iterator<AsyncAppender.DiscardSummary> iter = this.discardMap.values().iterator();
                            while (iter.hasNext())
