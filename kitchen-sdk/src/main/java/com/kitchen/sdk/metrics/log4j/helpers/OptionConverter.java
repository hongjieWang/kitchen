package com.kitchen.sdk.metrics.log4j.helpers;

import com.kitchen.sdk.metrics.log4j.Level;
import com.kitchen.sdk.metrics.log4j.PropertyConfigurator;
import com.kitchen.sdk.metrics.log4j.spi.Configurator;
import com.kitchen.sdk.metrics.log4j.spi.LoggerRepository;
...
public class OptionConverter {
    ...
    public static Level toLevel(String value, Level defaultValue) {
        ...
        try {
            ...
            LogLog.warn("class [" + clazz + "] is not a subclass of cn.org.bjca.footstone.metrics.client.log4j.Level", e);
    ...
    public static void selectAndConfigure(InputStream inputStream, String clazz, LoggerRepository hierarchy) {
        ...
        assert propertyConfigurator != null;
