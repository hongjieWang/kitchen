...
import com.kitchen.sdk.metrics.log4j.spi.LocationInfo;
            ...
            case 'd':
                ...
                if (dateFormatStr.equalsIgnoreCase("ISO8601")) {
                    ...
                    try {
                        ...
                        dateFormat = (DateFormat) OptionConverter.instantiateByClassName("cn.org.bjca.footstone.metrics.client.log4j.helpers.ISO8601DateFormat", DateFormat.class, null);
                    }
                }
